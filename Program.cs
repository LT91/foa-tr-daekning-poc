...
List<Tillidsrepraesentant> tillidsrepraesentanter)
        ...
        ) OpretTestdataHardcoded()
        {
            ...
            {
                new Arbejdssted(101, "Plejecenter Solsiden", "Solsiden 1", "Privat", "København", 55.7065, 12.5616),
                new Arbejdssted(102, "Børnehuset Regnbuen", "Regnbuevej 12", "Kommunal", "København", 55.6572, 12.5940),
                new Arbejdssted(201, "Plejecenter Skovgården", "Skovvej 5", "Kommunal", "Roskilde", 55.6415, 12.0878)
            };
